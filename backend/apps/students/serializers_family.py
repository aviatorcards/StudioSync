...
from apps.core.models import Family, User, Student
...
class ParentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ['email'] # Email usually unchangeable here for security, or managed via main User serializer
...
class FamilySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'studio', 
            'primary_parent', 'primary_parent_details',
            'secondary_parent', 'secondary_parent_details',
