...
from apps.lessons.models import ExternalCalendarFeed, ExternalCalendarEvent
...
class TestExternalCalendarFeedAPI:
    ...
    @patch("apps.lessons.import_calendar_views.requests.get", side_effect=_mock_fetch_ok)
    ...
    @patch(
        "apps.lessons.import_calendar_views.requests.get",
