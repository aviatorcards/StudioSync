...
from apps.core.models import Band, Studio, User
...
class Invoice(models.Model):
    ...
    band = models.ForeignKey(Band, on_delete=models.SET_NULL, null=True, blank=True, related_name='invoices')
    student = models.ForeignKey('core.Student', on_delete=models.SET_NULL, null=True, blank=True, related_name='invoices')
    
    # Attribution
    teacher = models.ForeignKey('core.Teacher', on_delete=models.SET_NULL, null=True, blank=True, related_name='invoices_generated')
    ...
    def __str__(self):
        subject = self.band.name if self.band else (self.student.user.get_full_name() if self.student else "Unknown")
    ...
    def calculate_totals(self):
        ...
        self.total_amount = self.subtotal + self.tax_amount - self.discount_amount + self.late_fee_amount
        self.save()
