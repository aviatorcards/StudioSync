...
from apps.core.models import Band, Student, Studio, Teacher
from apps.inventory.models import PracticeRoom
from apps.lessons.models import Lesson, LessonNote
