...
class InventoryItemAdmin(admin.ModelAdmin):
    list_display = ['name', 'category', 'quantity', 'available_quantity', 'condition', 'status', 'value', 'location']
...
class CheckoutLogAdmin(admin.ModelAdmin):
    list_display = ['item', 'student', 'quantity', 'checkout_date', 'due_date', 'status', 'is_overdue']
