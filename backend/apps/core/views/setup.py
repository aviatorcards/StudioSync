        ...
        if not setup_status:
            setup_status = SetupStatus.objects.create(
                ...
                features_enabled={
                    ...
                    for feature in ['billing', 'inventory', 'messaging', 'resources',
                                  'goals', 'bands', 'analytics', 'practice_rooms']
                },
                setup_data={'language': data.get('language', 'en'), 'completed_by': admin_user.email}
            )
        else:
            ...
            setup_status.setup_data = {'language': data.get('language', 'en'), 'completed_by': admin_user.email}
            setup_status.save()
