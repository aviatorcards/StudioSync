...
import { Copy, Eye, EyeOff, Key, Plus, Trash2, ChevronLeft } from 'lucide-react';
...
export default function APIKeysPage() {
    ...
    return (
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            {/* Back link */}
