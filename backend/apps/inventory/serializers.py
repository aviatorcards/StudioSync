...
class InventoryItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = InventoryItem
        fields = [
            'id', 'name', 'category', 'quantity', 'available_quantity',
            'condition', 'status', 'location', 'value', 'notes',
            'last_maintenance', 'purchase_date', 'serial_number',
            'is_borrowable', 'max_checkout_days', 'is_low_stock',
...
class CheckoutLogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'quantity', 'checkout_date', 'due_date', 'return_date',
            'status', 'notes', 'approved_by', 'approved_by_name',
...
class PracticeRoomSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = PracticeRoom
        fields = [
            'id', 'name', 'capacity', 'description', 'equipment',
...
class RoomReservationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'room', 'room_name', 'student', 'student_name',
            'start_time', 'end_time', 'duration_hours', 'status',
            'notes', 'total_cost', 'is_paid', 'created_at', 'updated_at'
        ]
