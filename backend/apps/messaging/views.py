...
from .serializers import MessageSerializer, MessageThreadSerializer, NotificationSerializer
from apps.core.models import Studio, User # Need Studio for Thread creation
...
class MessageThreadViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if not studio:
             return Response({"error": "Could not determine context (Studio) for this message"}, status=status.HTTP_400_BAD_REQUEST)
