...
from apps.resources.models import Resource, Setlist
...
class TestSetlistAPI:
    ...
    def test_create_setlist(self, teacher_authenticated_client):
        ...
        response = teacher_authenticated_client.post('/api/resources/setlists/', data, format='json')
    ...
    def test_add_resource_to_setlist(self, teacher_authenticated_client, teacher_user):
        ...
        response = teacher_authenticated_client.post(f'/api/resources/setlists/{setlist.id}/add-resource/', data, format='json')
