...
class CheckoutLog(models.Model):
    ...
    student = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='item_checkouts')
    quantity = models.IntegerField(default=1)
...
class PracticeRoom(models.Model):
    ...
    hourly_rate = models.DecimalField(max_digits=6, decimal_places=2, default=0, help_text="Cost per hour (0 for free)")
...
class RoomReservation(models.Model):
    ...
    student = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='room_reservations')
