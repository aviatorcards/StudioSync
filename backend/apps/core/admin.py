...
from .models import User, Studio, Teacher, Student, Band
...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ('first_name', 'last_name', 'phone', 'role', 'timezone', 'avatar')}),
...
class BandAdmin(admin.ModelAdmin):
    ...
    list_filter = ('studio',)
    search_fields = ('name', 'billing_email', 'primary_contact__first_name', 'primary_contact__last_name')
    ordering = ('-created_at',)
    readonly_fields = ('created_at', 'updated_at')
