...
from .models import Lesson, RecurringPattern, LessonNote, StudentGoal
...
class LessonAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Basic Information', {
            'fields': ('studio', 'teacher', 'student', 'band', 'room')
        }),
        ('Lesson Details', {
            'fields': ('lesson_type', 'status')
        }),
        ('Scheduling', {
            'fields': (
                'scheduled_start',
...
class RecurringPatternAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Schedule Pattern', {
            'fields': ('frequency', 'day_of_week', 'time', 'duration_minutes')
        }),
        ('Date Range', {
