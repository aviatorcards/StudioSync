...
from apps.core.models import Teacher, Student, Studio
...
class RecurringPattern(models.Model):
    ...
    teacher = models.ForeignKey(Teacher, on_delete=models.CASCADE, related_name='recurring_patterns')
    student = models.ForeignKey(Student, on_delete=models.CASCADE, related_name='recurring_patterns')
...
class StudentGoal(models.Model):
    ...
    teacher = models.ForeignKey(Teacher, on_delete=models.CASCADE, related_name='student_goals', null=True, blank=True)
...
class LessonPlan(models.Model):
    ...
    # Relationships
    created_by = models.ForeignKey(Teacher, on_delete=models.CASCADE, related_name='created_lesson_plans')
    resources = models.ManyToManyField('resources.Resource', related_name='lesson_plans', blank=True)
