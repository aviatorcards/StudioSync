...
from apps.lessons.models import ExternalCalendarEvent, ExternalCalendarFeed
from apps.lessons.serializers import ExternalCalendarEventSerializer, ExternalCalendarFeedSerializer
