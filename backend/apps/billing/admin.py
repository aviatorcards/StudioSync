...
from .models import Invoice, Payment, InvoiceLineItem, PaymentMethod
...
class InvoiceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Basic Information', {
            'fields': ('invoice_number', 'studio', 'status', 'teacher')
        }),
        ('Bill To', {
            'fields': ('band', 'student')
        }),
        ...
        ('Dates', {
            'fields': ('issue_date', 'due_date', 'paid_date', 'sent_at', 'is_overdue')
        }),
        ('Notes', {
        ...
        ('Payment Integration', {
            'fields': ('stripe_session_id', 'late_fee_applied'),
            'classes': ('collapse',)
        }),
        ('Metadata', {
...
class PaymentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Transaction Info', {
            'fields': ('transaction_id', 'notes', 'processed_by')
        }),
        ('Timestamps', {
...
class PaymentMethodAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Basic Information', {
            'fields': ('band', 'provider', 'provider_payment_method_id')
        }),
        ('Card Details', {
